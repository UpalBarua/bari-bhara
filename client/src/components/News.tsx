...
const News = () => {
  return (
    <div>
      <section className="px-5 py-10 bg-sky-50 dark:bg-gray-800 dark:text-gray-100">
        <div className="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url(https://images.unsplash.com/photo-1557428894-56bcc97113fe?q=80&w=1472&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)",
            }}
          >
