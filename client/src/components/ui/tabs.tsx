...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-md bg-primary-100 p-1 text-primary-500 dark:bg-primary-900 dark:text-primary-300',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ref={ref}
    className={cn(
      'inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-white transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-white data-[state=active]:text-primary-950 data-[state=active]:shadow-sm dark:ring-offset-primary-950 dark:focus-visible:ring-primary-300 dark:data-[state=active]:bg-primary-950 dark:data-[state=active]:text-primary-50',
      className
    )}
    {...props}
  />
