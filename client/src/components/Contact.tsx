...
const Contact = () => {
  return (
    <div>
      <section className="py-6 bg-sky-50 dark:bg-gray-800 dark:text-gray-50">
        <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
          ...
          <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
            ...
            <label className="block">
              ...
              <textarea className="block w-full rounded-md focus:ring focus:ri focus:ri dark:bg-gray-800"></textarea>
            </label>
            <button
              type="button"
